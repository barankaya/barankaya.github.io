...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = "./profil.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Baran Kaya");
    			attr_dev(img, "class", "svelte-1ds25jv");
    			add_location(img, file$4, 17, 1, 297);
    			add_location(strong0, file$4, 24, 11, 409);
    			add_location(br0, file$4, 24, 35, 433);
    			add_location(strong1, file$4, 25, 3, 442);
    			add_location(br1, file$4, 25, 31, 470);
    			add_location(strong2, file$4, 26, 12, 488);
    			add_location(code, file$4, 23, 2, 390);
    			attr_dev(h1, "id", "intro");
    			attr_dev(h1, "class", "svelte-1ds25jv");
    			add_location(h1, file$4, 22, 1, 371);
    			attr_dev(p0, "id", "desc");
    			attr_dev(p0, "class", "svelte-1ds25jv");
    			add_location(p0, file$4, 29, 1, 537);
    			attr_dev(a0, "href", a0_href_value = "https://linkedin.com/in/" + /*linkedinHandle*/ ctx[4]);
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$4, 31, 2, 573);
    			attr_dev(a1, "href", a1_href_value = "https://github.com/" + /*githubHandle*/ ctx[3]);
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$4, 34, 2, 731);
    			add_location(p1, file$4, 30, 1, 566);
    			attr_dev(main, "class", "svelte-1ds25jv");
    			add_location(main, file$4, 16, 0, 288);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*summary*/ 32) set_data_dev(t10, /*summary*/ ctx[5]);

    			if (!current || dirty & /*linkedinHandle*/ 16 && a0_href_value !== (a0_href_value = "https://linkedin.com/in/" + /*linkedinHandle*/ ctx[4])) {
    				attr_dev(a0, "href", a0_href_value);
    			}

    			if (!current || dirty & /*githubHandle*/ 8 && a1_href_value !== (a1_href_value = "https://github.com/" + /*githubHandle*/ ctx[3])) {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let { summary } = $$props;
    	const writable_props = ["name", "position", "location", "githubHandle", "linkedinHandle", "summary"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("githubHandle" in $$props) $$invalidate(3, githubHandle = $$props.githubHandle);
    		if ("linkedinHandle" in $$props) $$invalidate(4, linkedinHandle = $$props.linkedinHandle);
    	...
    	return [name, position, location, githubHandle, linkedinHandle, summary];
    }
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*githubHandle*/ ctx[3] === undefined && !("githubHandle" in props)) {
    			console.warn("<App> was created without expected prop 'githubHandle'");
    		}

    		if (/*linkedinHandle*/ ctx[4] === undefined && !("linkedinHandle" in props)) {
    			console.warn("<App> was created without expected prop 'linkedinHandle'");
    		}

    		if (/*summary*/ ctx[5] === undefined && !("summary" in props)) {
    			console.warn("<App> was created without expected prop 'summary'");
    		}
    	}
